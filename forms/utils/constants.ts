export const CONSTANTS = {
    whyThis : [
        'Navigating government websites to find the right forms can often be a frustrating and time-consuming experience. We created this website to simplify that process for the people of Punjab, India. By consolidating all publicly available state forms in one place, our goal is to provide a straightforward, user-friendly platform where you can easily find, preview, and download the forms you need.',
        'In addition to a clean and intuitive interface, we offer offline downloads to ensure that you always have access to important documents, even when official links might be down. This platform is designed to save you time and reduce the hassle of finding government forms, making it easier for you to access the information you need, when you need it.'
    ],
    disclaimer: [
